...
namespace Titled_Gui.Classes
{
    internal class OffsetGetter
    {
        ...
        private static readonly Dictionary<string, List<Offset>> FieldNameMappings = new()
        {
            ...
            { "dwInputSystem", new() { new Offset("dwInputSystem") } },
            ...
            { "m_flMaxspeed", new() { new Offset("m_flMaxspeed") } },
            { "m_flInaccuracyPitchShift", new() { new Offset("m_flInaccuracyPitchShift") } },
            { "m_vecCsViewPunchAngle", new() { new Offset("m_vecCsViewPunchAngle") } },
            { "m_pMovementServices", new() { new Offset("m_pMovementServices") } },
            { "dwNetworkGameClient", new() { new Offset("dwNetworkGameClient") } },
            { "dwLocalPlayer", new() { new Offset("dwLocalPlayer") } },
            { "m_flFallbackWear", new() { new Offset("m_flFallbackWear") } },
            { "m_nFallbackPaintKit", new() { new Offset("m_nFallbackPaintKit") } },
            { "m_nFallbackSeed", new() { new Offset("m_nFallbackSeed") } },
            { "m_nFallbackStatTrak", new() { new Offset("m_nFallbackStatTrak") } },
            { "m_iItemIDHigh", new() { new Offset("m_iItemIDHigh") } },
            { "m_iEntityQuality", new() { new Offset("m_iEntityQuality") } },
            { "m_iAccountID", new() { new Offset("m_iAccountID") } },
            { "m_OriginalOwnerXuidLow", new() { new Offset("m_OriginalOwnerXuidLow") } },
            { "m_WeaponCount", new() { new Offset("m_WeaponCount") } },
            { "m_pViewModelServices", new() { new Offset("m_pViewModelServices") } },
            { "m_hViewModel", new() { new Offset("m_hViewModel") } },

            { "m_vecBulletHitModels", new() { new Offset("m_vecBulletHitModels") } },
            { "bullet_matLocal", new() { new Offset("m_matLocal") } },
            { "bullet_iBoneIndex", new() { new Offset("m_iBoneIndex") } },
            { "bullet_hPlayerParent", new() { new Offset("m_hPlayerParent") } },
            { "bullet_bIsHit", new() { new Offset("m_bIsHit") } },
            { "bullet_flTimeCreated", new() { new Offset("m_flTimeCreated") } },
            { "bullet_vecStartPos", new() { new Offset("m_vecStartPos") } },
            { "m_sSanitizedPlayerName", new() { new Offset("m_sSanitizedPlayerName") } },
            ...
            { "m_hObserverPawn", new() { new Offset("m_hObserverPawn") } },
            { "m_iObserverMode", new() { new Offset("m_iObserverMode") } },
            { "m_hController", new() { new Offset("m_hController") } },
            ...
            { "m_vecOldViewAngles", new() { new Offset("m_vecOldViewAngles", "CPlayer_MovementServices") } },
            { "m_vecLastMovementImpulses", new() { new Offset("m_vecLastMovementImpulses", "CPlayer_MovementServices") } },
            { "m_flUpMove", new() { new Offset("m_flUpMove", "CPlayer_MovementServices") } },
            { "m_flLeftMove", new() { new Offset("m_flLeftMove", "CPlayer_MovementServices") } },
            { "m_flForwardMove", new() { new Offset("m_flForwardMove", "CPlayer_MovementServices") } },
            { "m_arrForceSubtickMoveWhen", new() { new Offset("m_arrForceSubtickMoveWhen", "CPlayer_MovementServices") } },
        ...
        private static void UpdateOffsetsClass()
        {
            ...
            Type offsetsType = typeof(Data.Game.Offsets);
