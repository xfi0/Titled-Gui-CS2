...
namespace Titled_Gui.Modules.Visual
{
    internal class Radar
    {
        ...
        {
            GameState.renderer.drawList.AddLine(new Vector2(CrossPosition.X - 100, CrossPosition.Y), new Vector2(CrossPosition.X + 100, CrossPosition.Y), ImGui.ColorConvertFloat4ToU32(Classes.Colors.EnemyColor), 1); // enemy color because uh i felt like it
            GameState.renderer.drawList.AddLine(new Vector2(CrossPosition.X, CrossPosition.Y - 100), new Vector2(CrossPosition.X, CrossPosition.Y + 100), ImGui.ColorConvertFloat4ToU32(Classes.Colors.EnemyColor), 1);
        }
    }
